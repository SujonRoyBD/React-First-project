...
const data=[
    {
      img:"../../../src/assets/newImages/real-estate-graph 1-1.png" ,
    ...
    {
        img:"../../../src/assets/newImages/real-estate-graph 1-2.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 1-3.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 1-4.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 1-5.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 1-6.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 1-7.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 1-8.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 1-9.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 2.png" ,
      ...
      {
        img:"../../../src/assets/newImages/real-estate-graph 1.png" ,
...
const Benifits = () => {
  return (
    <div data-aos="zoom-in">
        ...
        <span className=' flex justify-center gap-3'><img  src="../../../src/assets/headingIcon.webp" alt="" /><p>Trusted</p></span>
