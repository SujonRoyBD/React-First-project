    ...
    <div>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-7 px-12 '>
        <div data-aos="fade-right">
          <img src="../../../src/assets/aboutUs.webp" alt="about" height={100} width={8000} />
        </div>
        <div data-aos="fade-left">
          <span className='flex gap-3'><img src="../../../src/assets/headingIcon.webp" alt="" /><p>Aboutus</p></span>
      ...
      <div  className=' grid grid-cols-1 md:grid-cols-2 gap-7 mt-8 px-12'>
        <div data-aos="fade-left" >
          <span  className='flex gap-3'><img src="../../../src/assets/headingIcon.webp" alt="" /><p>Basement Renovations</p></span>
        ...
        <div>
          <div >
            <img src="../../../src/assets/forigner.webp" alt="about" height={100} width={8000} />
          </div>
        </div>
      </div>
