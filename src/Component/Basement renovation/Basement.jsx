...
// import bg__img from "../../../src/assets/img/bg hero.png";
const Basement = () => {
  return (
    <div data-aos="fade-left" style={{backgroundImage : `url("../../../src//assets/img/bg hero.png")`}} className='bg-cover bg-center bg-no-repeat h-screen sm:w-[500px] md:w-full '>
