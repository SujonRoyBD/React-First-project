  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 mt-9 gap-7'>
       <div  data-aos="fade-right">
        <img src="/assets/newImages/Ready to Start.png" alt="about" height={100} width={8000}/>
       </div>
       <div data-aos="fade-left" className='pr-8 sm: px-6'>
       <span className='flex gap-3'><img  src="/assets/headingIcon.webp" alt="" /><p>Expert, Well Equipped</p></span>
     <h1 className='font-bold text-2xl'>Expert, Well Equipped Renovation <br /> Contractors</h1>
