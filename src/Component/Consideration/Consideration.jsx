...
const Consideration = () => {
  return (
    <div data-aos="zoom-in" className=' mt-9'>
       <span className='flex gap-3 justify-center'><img  src="../../../src/assets/headingIcon.webp" alt="" /><p>Consideration & Limitation</p></span>
      ...
      <div className='grid grid-cols-1 md:grid-cols-6 mt-9'>
        <div className='md:col-span-1'>
            <img className='h-full' src="../../../src/assets/consideration1.webp" alt="" />
        </div>
        ...
        <div className='md:col-span-1'>
            ...
            <img className='h-full' src="../../../src/assets/consideration2.webp" alt="" />
        </div>
