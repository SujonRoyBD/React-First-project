    ...
    return (
        <div data-aos="zoom-in" className='text-center'>
            ...
            <div className='flex justify-center'>
                <p className='text-2xl font-bold text-center mt-4 bg-black w-[900px] text-white px-7 rounded-full flex justify-center py-2'>Our Basement Renovation Contractors Do</p>
            </div>
